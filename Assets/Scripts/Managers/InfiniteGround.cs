...
//         {
//             GameObject chunk = Instantiate(groundChunks[0], new Vector3((i * chunkWidth) + levelData.chunkGap, -2, 0), Quaternion.identity);
...
//             leftmost.position = activeChunks[activeChunks.Length - 2].position + (Vector3.right * chunkWidth) + (Vector3.right * levelData.chunkGap);
